...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0m0rbri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0m0rbri.containers.anotherwebservice.com/
...
```
git clone git@github.com:zatchati0/container-0m0rbri.git
cd container-0m0rbri
```
...
```
docker attach container-0m0rbri
```
